...
namespace LogWatcher.Common
{
    ...
    public class LogConfig
    {
        ...
        public void Save()
        {
            ...
            {
                this.ConfigError?.Invoke("Saving configuration error occur: " + ex.Message);
            }
        }
        ...
        private void SaveProfile(Profile profile)
        {
            ...
            {
                this.ConfigError?.Invoke("Saving profile error occur : " + ex.Message);
            }
        }
        ...
        private static void LoadConfigFile()
        {
            ...
            {
                _singleton = new LogConfig();
                //this.ConfigError?.Invoke("Loading configuration error occur" + ex.Message);
            }
